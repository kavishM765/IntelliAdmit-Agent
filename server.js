...
function createChatSession() {
    // Stability fix: Using 1.5-flash which is confirmed to work with tool calls
    const model = genAI.getGenerativeModel({ 
        ...
        - Fees: CSE is highest, IT/AIML moderate, MBA lowest.
        
        Instructions: Once you have Name, Phone, Email, and Domain, use 'saveInquiry'.`
    });
    ...
    return model.startChat({
        tools: [{
            functionDeclarations: [{
                name: "saveInquiry",
                description: "Saves a verified student inquiry.",
                parameters: {
                    type: "OBJECT",
                    properties: {
                        name: { type: "STRING" },
    ...
    clientWs.on('message', async (message) => {
        try {
            ...
            try {
                ...
                // Fixed: Correct SDK way to handle tool calls
                ...
                if (calls && calls.length > 0) {
                    ...
                    if (call.name === "saveInquiry") {
                        ...
                        try {
                            ...
                            // UPDATED: Gmail Template with your required Fee Table
                            const studentMailOptions = {
                                ...
                                <div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; border: 1px solid #ddd; padding: 20px; border-radius: 10px;">
                                    ...
                                    <p>Thank you for your interest. We are delighted to provide you with the fee details for our primary departments:</p>
                            ...
                            clientWs.send(JSON.stringify({ reply: `I have successfully saved your details for the **${domain}** program and emailed you the official fee structure! 🎉` }));
                            return;
