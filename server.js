...
function createChatSession() {
    // We use 1.5-flash for maximum reliability in tool calling
    const model = genAI.getGenerativeModel({ 
        ...
        Contact: 9865824929.
        Once you have Name, Phone, Email, and Domain, use 'saveInquiry'.`
    });
    ...
    return model.startChat({
        tools: [{
            functionDeclarations: [{
                name: "saveInquiry",
                description: "Saves verified student inquiry and sends emails.",
                parameters: {
                    type: "OBJECT",
                    properties: {
                        name: { type: "STRING" },
    ...
    clientWs.on('message', async (message) => {
        try {
            ...
            try {
                        ...
                        try {
                            ...
                            const studentMailOptions = {
                                ...
                                <div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; border: 1px solid #ddd; padding: 20px; border-radius: 10px;">
                                    ...
                                    <p>Thank you for your inquiry. Here are the fee details for our departments:</p>
                                    ...
                                    <div style="background-color: #f9f9f9; padding: 15px; margin-top: 20px;">
                                        <p><strong>Admission Office:</strong> +91 9489465755, +91 9865824929</p>
                                    </div>
                                    <p>Regards,<br><strong>Admissions Team</strong></p>
                                </div>`
                            };

                            await transporter.sendMail(studentMailOptions);
                            clientWs.send(JSON.stringify({ reply: `I have saved your details for **${domain}** and emailed you the fee structure! 🎉` }));
                            return;
                ...
                clientWs.send(JSON.stringify({ reply: "I'm having a connection issue. Please try again or leave your contact info!" }));
            }
